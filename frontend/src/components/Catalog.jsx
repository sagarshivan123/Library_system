...
<header className='flex flex-col gap-3 sm:flex-row md:items-center'>
  <button className={`relative rounded sm:rounded-br-none sm:rounded-tr-none sm:rounded-tl-lg  sm:rounded-bl-lg text-center border-2 font-semibold py-2 w-full sm:w-72 
  ${filter==="borrowed" ? "bg-black text-white border-black"
    :" bg-gray-200 text-black border-gray-200 hover:bg-gray-300"}`}
  onClick={()=>setFilter("borrowed")}>
    Borrowed Books
    </button>

<button className={`relative rounded sm:rounded-bl-none sm:rounded-tl-none sm:rounded-tr-lg  sm:rounded-br-lg text-center border-2 font-semibold py-2 w-full sm:w-72 
${filter==="overdue" ? "bg-black text-white border-black":" bg-gray-200 hover-gray-200 hover:bg-gray-300"}`}
...

{
  booksToDisplay && booksToDisplay.length>0?(
    ...
    </div>):(<h3 className='text-3xl mt-5 font-medium'>
