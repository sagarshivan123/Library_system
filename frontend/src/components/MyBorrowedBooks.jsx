...
//   console.log("Book ID passed:", id);
// console.log("Books array:", books);
// console.log("Found book:", book);

};
// console.log("book info",readBook)
...
<header className='flex flex-col gap-3 sm:flex-row md:items-center'>
  ...
  ${filter==="returned" ? "bg-black text-white border-black":" bg-gray-200 hover-gray-200 hover:bg-gray-300"}`}
...
${filter==="nonReturned" ? "bg-black text-white border-black":" bg-gray-200 hover-gray-200 hover:bg-gray-300"}`}
        ...
        <tbody>
          {
            booksToDisplay.map((book,index)=>(
              <tr key={`${index}`} className={(index+1) % 2===0 ? "bg-gray-50":""}>
                ...
                <td className='px-4 py-2'>{book.bookTitle}
                </td>
