...
<div className='flex flex-col-reverse xl:flex-row '>
  {/* Left Side  */}
<div className='flex flex-[4] flex-col gap-7 lg:gap-7 lg:py-5 justify-between xl:min-h-[85.5vh] w-full'>
  <div className='flex flex-col gap-7 flex-[4]'>
   <div className='flex flex-col gap-7 overflow-y-hidden w-full'>
    <div className='flex items-center gap-3 bg-white p-5 min-h-[120px] rounded-lg transition hover:shadow-inner duration-300'>
      ...
      <p className='text-lg xl:text-xl font:semibold'>Your Borrowed Book List
      </p>
    </div>
    <div className='flex items-center gap-3 bg-white p-5 min-h-[120px]  rounded-lg transition hover:shadow-inner duration-300'>
      <span className='w-[2px] bg-black h-20 lg:h-full'></span>
      <span className='bg-gray-300 h-20 lg:h-full min-w-20 flex justify-center items-center rounded-lg'>
        <img src={returnIcon} alt='book-icon' className='w-8 h-8'/></span>
      <p className='text-lg xl:text-xl font:semibold'>Your Returned Book List</p>
    </div>
   </div>
<div className='flex flex-col lg:flex-row gap-7'>
<div className='flex items-center gap-3 bg-white p-5 min-h-[120px] n rounded-lg transition hover:shadow-inner duration-300'>
      <span className='w-[2px] bg-black h-20 lg:h-full'></span>
      <span className='bg-gray-300 h-20 lg:h-full min-w-20 flex justify-center items-center rounded-lg'>
        <img src={browseIcon} alt='book-icon' className='w-8 h-8'/></span>
  ...
  <div className='bg-white p-7 text-lg sm:text-xl xl:text-3xl 2xl:text-4xl max-h-52 font-semibold relative flex-[3] flex justify-center items-center rounded-2xl'>
